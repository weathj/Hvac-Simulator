    ...
    return (
        <div className="panel-grid">
                <Panel title="Supply Air" variant="supply">
                    ...
                    <StatRow label="Flow"         value={ahu?.sa_flow}           unit=" CFM"    decimals={0}/>
                ...
                <Panel title="Mixed Air" variant="mixed">
                    ...
                    <StatRow label="Flow"            value={ahu?.ma_flow}             unit=" CFM"    decimals={0}/>
                </Panel>

                <Panel title="Return Air" variant="return">
                    <StatRow label="Temperature" value={ahu?.ra_temp} unit=" °F"  decimals={2}/>
                    <StatRow label="Flow"        value={ahu?.ra_flow} unit=" CFM"    decimals={0}/>
                ...
                <Panel title="Outside Air" variant="outside">
                    ...
                    <StatRow label="Outdoor Flow"    value={ahu?.outdoor_air_flow}  unit=" CFM"    decimals={0} />
