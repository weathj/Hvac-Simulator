...
urlpatterns = [
    ...
    path('api/airunit/<uuid:pk>/', api_views.AirUnitValuesView.as_view(), name='airunit-values'),
    path('api/zone/<uuid:pk>/', api_views.ZoneValuesView.as_view(), name='zone-values'),
